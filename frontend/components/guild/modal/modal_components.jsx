...
export const AddGuildOptions = () => (
  <div id='add-guild-options' className='add-guild-component'
    ...
    <header id='add-guild-header'>Oh, another server huh?</header>
    <div id='add-guild-actions'>
      <div className='add-guild-action'>
        ...
        <button id='add-guild-button' onClick={clickCreate}>Create a server</button>
      </div>
      <div className='add-guild-action'>
        ...
        <button id='join-guild-button' onClick={clickJoin}>Join a server</button>
      </div>
