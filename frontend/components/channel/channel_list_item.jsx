...
class ChannelListItem extends React.Component {
  ...
  render() {
    const urlId = parseInt(this.props.match.params.channelId);
    const channel = this.state;
    return (
      <div className={`channel-list-item ${(channel.id === urlId) ? 'current-channel' : ''}`} onClick={this.clickChannel}>
  ...
  clickChannel(e) {
    ...
    this.props.history.replace(`/channels/${guildId}/${id}`);
  }
}
